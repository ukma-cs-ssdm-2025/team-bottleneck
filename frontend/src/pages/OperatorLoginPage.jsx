...
function OperatorLoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const isOperator = userData.is_operator && userData.lot_id;

            if (!isOperator) {
                setError('Цей обліковий запис не має прав оператора.');
                setLoading(false);
                return;
            }
            ...
            <Paper elevation={3} sx={{ mt: 8, p: 4, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                    ...
                    <Button
                        ...
                        disabled={loading}
                    >
                        {loading ? <CircularProgress size={24} color="inherit" /> : 'УВІЙТИ ЯК ОПЕРАТОР'}
                    </Button>
