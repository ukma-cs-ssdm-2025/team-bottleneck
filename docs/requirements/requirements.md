...
- NFR-001 (Performance): Список доступних паркомісць або історії оплат має відображатися ≤ 3 секунд після запиту.
...
- NFR-005 (Usability): Вебсайт повинен бути адаптивним для мобільних пристроїв (екрани від 5’’ і більше), без горизонтального скролінгу та з повним функціоналом.
- NFR-006 (Usability): Повідомлення про помилки та push-сповіщення мають бути зрозумілою мовою (щоб користувач, що не розумається в особливій термінології та технологіях міг зрозуміти в чому помилка) та містити інструкції для вирішення проблеми
