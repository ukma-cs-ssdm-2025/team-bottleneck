...
- FR-006: Система повинна автоматично адаптувати користувацький інтерфейс під розмір екрану мобільного пристрою.
- FR-007: Система повинна автоматично створювати резервні копії БД.
- FR-008: Система повинна зберігати і відображати історію транзакцій користувача.
